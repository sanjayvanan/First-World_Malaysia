...
import { Shield, Users, LogOut, UserCog, ChevronLeft, ChevronRight } from 'lucide-react';
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const [usersRes, adminsRes] = await Promise.all([
        // Pass page and limit params
        axios.get(`http://localhost:5000/api/superuser/users?page=${page}&limit=20`, config),
